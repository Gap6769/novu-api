    ...
    try:
        ...
        tbate_update = NovelUpdate(
            ...
            cover_image_url=HttpUrl(
                "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1506190670l/28705056.jpg"
            ),
        ...
        if tbate:
            await db["novels"].update_one({"_id": tbate["_id"]}, {"$set": tbate_update.model_dump(exclude_unset=True)})
