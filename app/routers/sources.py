...
async def create_source(source: SourceCreate, source_repository: SourceRepository = Depends(get_source_repository)):
    """Create a new source."""
...
async def get_source(source_id: str, source_repository: SourceRepository = Depends(get_source_repository)):
...
async def update_source(
    source_id: str, source: SourceUpdate, source_repository: SourceRepository = Depends(get_source_repository)
):
    """Update a source."""
...
async def delete_source(source_id: str, source_repository: SourceRepository = Depends(get_source_repository)):
    """Delete a source."""
...
async def test_source(source_id: str, url: str, source_repository: SourceRepository = Depends(get_source_repository)):
