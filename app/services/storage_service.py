...
class StorageService:
    ...
    async def _get_chapter_path(
        self, novel: Union[str, Dict[str, Any]], chapter_number: int, content_type: str, language: str = "en"
    ) -> Path:
    ...
    async def get_chapter(
        self, novel: str, chapter_number: int, content_type: str, language: str = "en"
    ...
    async def save_manhwa_chapter(
        self, novel: Union[str, Dict[str, Any]], chapter_number: int, content: Dict[str, Any]
    ) -> None:
    ...
    async def get_manhwa_chapter(
        self, novel: Union[str, Dict[str, Any]], chapter_number: int
